...
DATA_ROOT = r"..\..\..\..\bayonetta"

def iter_all_wmb():
	return glob.glob(os.path.join(DATA_ROOT, "*\*\*\*.wmb"))

def get_iter_one_pack_wmb(i):
	def iter_one_pack_wmb():
		return glob.glob(os.path.join(DATA_ROOT, r"data%02d_files\*\*\*.wmb" % i))
...
test_bm0020 = make_common_test(os.path.join(DATA_ROOT, r"data01_files\bm\bm0020\bm0020.wmb"),
							   dump_obj=False)
test_em001f = make_common_test(os.path.join(DATA_ROOT, r"data01_files\em\em001f\em001f.wmb"),
							   dump_obj=False)
